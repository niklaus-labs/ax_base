...
public class DisplayUtils {
    ...
    /**
     * Returns the physical-to-current display size ratio for the display's maximum
     * resolution mode. Used by the tri-state (alert slider) HUD to place its dialog.
     */
